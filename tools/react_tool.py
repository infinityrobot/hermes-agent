...
REACT_SCHEMA = {
    ...
    "description": (
        ...
        "human touch. Use it SPARINGLY, for moments that genuinely warrant "
        "one: celebrating good news, accepting thanks/praise (🙏), strong "
        "agreement, a shared laugh, or when explicitly asked to react. Routine "
        "messages and plain factual questions do NOT need a reaction — most of "
        "the time, just reply. But when a moment DOES call for one, make it "
        "count: the best reactions are witty, unexpected, a little cheeky — "
        "reach past the obvious 👍 for something apter or funnier (🏆 for a "
        "great call, ❄️ for 'it's winter'). Rare but delightful beats frequent "
        "and bland.\n\n"

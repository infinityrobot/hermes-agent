...
REACTION_RESPONSE_GUIDANCE = (
    ...
    "Reactions express sentiment or a social beat — they are NOT status "
    "signals. Never use a reaction to mean 'I'm looking into it', 'working on "
    "it', or 'done' (👀 / ⏳ / ✅ are progress markers handled separately, not "
    "reactions for you to send). If you're about to answer a question or "
    "handle a request, just do it — don't react with 👀 in place of engaging.\n"

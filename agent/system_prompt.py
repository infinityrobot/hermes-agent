...
def build_system_prompt_parts(agent: Any, system_message: Optional[str] = None) -> Dict[str, str]:
    ...
    # When the agent can react to messages, tell it a reaction is a complete
    # response — an explicit carve-out from the "report what you did" guidance
    # above, which otherwise nudges a redundant confirmation after reacting.
    if "react" in (agent.valid_tool_names or set()):
        stable_parts.append(REACTION_RESPONSE_GUIDANCE)
